...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setListenerToList();
		myLists = new MyListView<ShoppingList>(this, android.R.layout.simple_list_item_1, myListsView);
		getMyLists();
	}
	...
	private void setListenerToList() 
	{
		myListsView.setOnItemClickListener(new OnItemClickListener() {
			...
			{
				ShoppingList selectedList = (ShoppingList) myListsView.getItemAtPosition(position);
